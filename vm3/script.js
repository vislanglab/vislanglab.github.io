...
//TO CHANGE THE INSTRUCTION TEXT edit this
	//var instructions = "In this experiment, you will be presented with two screens in each trial, which will have either an image or a word on them. Your job is to say whether the image or word on the screen matches the meaning of the one on the previous screen. On the keyboard, you will press a 1 (YES) if it matches, or a 0 (NO) if it does not match. Please press the space bar when you're ready."
	...
	"<p>In this experiment, you will be presented with two screens in each trial, which will have either an image or a word on them.</p>"+
	"<p>Your job is to say whether the image or word on the screen matches the meaning of the one on the previous screen.</p>"+
	"<p>On the keyboard, you will press a 1 (YES) if it matches, or a 0 (NO) if it does not match.</p>"+
...
//TO CHANGE THE SOURCE IMAGES ETC
	//var URL_stem = "https://vislanglab.github.io/vm3/img/"; //location of the stimuli, URL or...
	...
	// i.e., loop through the data source, adding each item to named properties
		...
		trialProps=["list","Experiment","ScenarioNum","ScenarioType","Condition","ConditionType","Match","WordType","Conventionality","ConventionalityScore","MatchScore","Word","MeaningType","panel1","panel2"];
