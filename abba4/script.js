...
//TO CHANGE THE INSTRUCTION TEXT edit this
	//var instructions = "You will now see short comic strips like the ones you might see in a newspaper. Below this, you will see an additional panel. Your job is to decide where that panel at the bottom would best be placed in the sequence to create an effective narrative. To identify where the panel goes, you will press a number (1, 2, 3, or 4) which corresponds with a possible position in the sequence."
	...
	"<p>You will now see short comic strips like the ones you might see in a newspaper. Below this, you will see an additional panel.</p>"+
	"<p> Your job is to decide where that panel at the bottom would best be placed in the sequence to create an effective narrative.</p>"+
	"<p>To identify where the panel goes, you will press a number (1, 2, 3, or 4) which corresponds with a possible position in the sequence.</p>"+
...
//TO CHANGE THE SOURCE IMAGES ETC
	//var URL_stem = "https://vislanglab.github.io/abba4/img/"; //location of the stimuli, URL or...
	...
	// i.e., loop through the data source, adding each item to named properties
		...
		trialProps=["list","strip","conditionPattern","CriticalPanel","Stimulus"];
