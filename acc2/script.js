...
//TO CHANGE THE INSTRUCTION TEXT edit this
	...
	"<p>You will now see various pictures and words.</p>"+
	"<p>For each one, please rate on a scale from 1 to 7 how much you would say this picture or word shows or describes something living. Make your choice by pressing a number from 1 ('It totally shows or describes something living') to 7 ('It does not show or describe something living at all') on the keyboard..</p>"+
...
//TO CHANGE THE SOURCE IMAGES ETC
	...
	// i.e., loop through the data source, adding each item to named properties
		...
		trialProps=["list","scenario","root","text","Animacytype","TypeNum","panel1"];
