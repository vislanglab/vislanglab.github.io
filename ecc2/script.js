...
//TO CHANGE THE SOURCE IMAGES ETC
	//var URL_stem = "https://vislanglab.github.io/ecc1/img/"; //location of the stimuli, URL or...
	...
	var n_trials = 90;//DataSource.length; //length of array gives number of sequences
...
trialProps=["List","Experiment","ScenarioNum","ScenarioType","Condition","ConditionType","SequenceNature","EnvisionTask", "AmbiguityRating","CategoricalSimilarityRating","Physical(colour)SimilarityRating","Panel1","Panel2","Panel3","Panel4","Panel5"];
