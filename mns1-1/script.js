...
//TO CHANGE THE INSTRUCTION TEXT edit this
	//var instructions = "You will now see a set of short comic strips like the ones you might see in a newspaper. Your job is simply to read them and try to understand the story. For each strip we just want you to tell us how easy it was to understand. Please press the space bar when you're ready."
	...
	"<p>For each strip we just want you to tell us how easy it was to understand by pressing the corresponding number on the keyboard.</p>"+
...
//TO CHANGE THE SOURCE IMAGES ETC
	//var URL_stem = "https://vislanglab.github.io/mns1-1/img/"; //location of the stimuli, URL or...
	...
	// i.e., loop through the data source, adding each item to named properties
		...
		trialProps=["list","strip","MNSstrip","conditionPattern","Condition","Complexity","panel1"];
