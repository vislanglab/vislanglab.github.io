...
//TO CHANGE THE SOURCE IMAGES ETC
	//var URL_stem = "https://vislanglab.github.io/mmspr/img/"; //location of the stimuli, URL or...
	...
	// i.e., loop through the data source, adding each item to named properties
		...
		trialProps=["list","strip","condition","TextCoherence","ImageCoherence","IncoherentOrder","panel1","panel2","panel3","panel4"];
