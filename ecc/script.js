...
//TO CHANGE THE SOURCE IMAGES ETC
	...
	var n_trials = 60;//DataSource.length; //length of array gives number of sequences
...
trialProps=["List","Experiment","ScenarioNum","ScenarioType","Condition","ConditionType","SequenceNature","Order","CategoricalSimilarityRating","Physical(colour)Similarity rating","panel1"];
