...
//TO CHANGE THE INSTRUCTION TEXT edit this
	...
	"<p>You will now see a set of short comic strips.</p>"+
	"<p>You will see a screen with a whole sequence, and then on the next screen you will make decisions about it.</p>"+
	"<p>To advance between screens, press 0 (zero) or a number for the decisions.</p>"+
...
//TO CHANGE THE SOURCE IMAGES ETC
	//var URL_stem = "https://vislanglab.github.io/fci/img/"; //location of the stimuli, URL or...
	...
	// i.e., loop through the data source, adding each item to named properties
		...
		trialProps=["list","strip","scenario","Condition#","Condition","panel1","panel2","panel3","panel4","panel5"];
