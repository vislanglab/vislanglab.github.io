...
//TO CHANGE THE INSTRUCTION TEXT edit this
	...
	"<p>You will see a screen with a sentence and can press spacebar to advance. Please read the sentence carefully.</p>"+
	"<p>You will then see a screen with emoji. Here, press Yes (1) or No (0) to indicate if the emoji could effectively follow the sentence.</p>"+
...
//TO CHANGE THE SOURCE IMAGES ETC
	//var URL_stem = "https://vislanglab.github.io/ewm3/img/"; //location of the stimuli, URL or...
	...
	// i.e., loop through the data source, adding each item to named properties
		...
		trialProps=["list","scenario","condition","CondType","TextType","ScenarioName","Sentence","Emoji"];
